...
def main():
    ...
    parser.add_argument('--cycle', type=int, help='Cycle', default=1)
    # train args
    ...
    args.data_file = args.data_dir + args.data_name + "-" + str(args.cycle) + '.txt'
    ...
    # save model args
    args_str = f'{args.backbone}-{args.data_name}-{args.cycle}'
