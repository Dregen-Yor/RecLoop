...
def main(
    ...
    tokenizer_temp = AutoTokenizer.from_pretrained(base_model, local_files_only=True)
    model.generation_config = GenerationConfig(
        pad_token_id=tokenizer_temp.eos_token_id,
        eos_token_id=tokenizer_temp.eos_token_id,
        bos_token_id=tokenizer_temp.bos_token_id,
        do_sample=False,
        temperature=1.0,
        top_k=None,
        top_p=None,
